...
package com.ue.common.imagepicker.ui;
...
import com.ue.common.imagepicker.GlideImgLoader;
import com.ue.common.imagepicker.ImgLoader;
import com.ue.common.imagepicker.Util;
import com.ue.common.imagepicker.bean.ImageItem;
import com.ue.common.imagepicker.bean.ImageSet;
import com.ue.common.imagepicker.data.DataSource;
import com.ue.common.imagepicker.data.OnImagesLoadedListener;
import com.ue.common.imagepicker.data.impl.LocalDataSource;
import com.ue.common.imagepicker.ui.activity.ImageCropActivity;
import com.ue.common.imagepicker.widget.SuperCheckBox;
...
public class ImagesGridFragment extends Fragment implements OnImagesLoadedListener,AndroidImagePicker.OnImageSelectedChangeListener,AndroidImagePicker.OnImageCropCompleteListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View contentView = inflater.inflate(R.layout.picker_fragment_images_grid,null);
        ...
        /*mGridView.setOnScrollListener(new PauseOnScrollListener(ImageLoader.getInstance(), false, true, new AbsListView.OnScrollListener() {
            ...
            public void onScrollStateChanged(AbsListView view, int scrollState) {
                ...
                if(scrollState == SCROLL_STATE_IDLE){
                    ...
                    LogUtil.i(TAG,"=====lastVisibleItem:"+lastPostion+"   preLoad:"+preSize);
    ...
    class ImageGridAdapter extends BaseAdapter{
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if(itemViewType == ITEM_TYPE_CAMERA){
                convertView = LayoutInflater.from(mContext).inflate(R.layout.picker_grid_item_camera, parent, false);
                ...
                if(convertView == null){
                    convertView = LayoutInflater.from(mContext).inflate(R.layout.picker_image_grid_item, null);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode == AndroidImagePicker.REQ_CAMERA && resultCode == Activity.RESULT_OK){
            if(!TextUtils.isEmpty(androidImagePicker.getCurrentPhotoPath())){
                ...
                LogUtil.i(TAG,"didn't save to your path");
            }
        }
