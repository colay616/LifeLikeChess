...
public class FlowRadioGroup extends LinearLayout {
    ...
    private FlowRadioGroup.OnCheckedChangeListener mOnCheckedChangeListener;
    ...
    public void addView(View child, int index, ViewGroup.LayoutParams params) {
        ...
        //!!!!!!!!!
            ...
            // 遍历复合控件
            setCheckedView((ViewGroup) child);
        }
        //!!!!!!!!!
     ...
     */
    public void setOnCheckedChangeListener(FlowRadioGroup.OnCheckedChangeListener listener) {
    ...
    public interface OnCheckedChangeListener {
         ...
         */
        public void onCheckedChanged(FlowRadioGroup group, @IdRes int checkedId);
    }
...
//                    id = View.generateViewId();
        ...
        public void onChildViewRemoved(View parent, View child) {
            ...
            //@@@@@@@@@@@@@@
                ...
                removeCheckedChangeListener((ViewGroup) child);
            }
            //@@@@@@@@@@@@@@
    ...
    /////////////////////
    private void removeCheckedChangeListener(ViewGroup group) {
        for (int i = 0,len = group.getChildCount(); i < len; i++) {
            if (group.getChildAt(i) instanceof RadioButton) {
                ((RadioButton) group.getChildAt(i)).setOnCheckedChangeListener(null);
            } else if (group.getChildAt(i) instanceof ViewGroup) {
                removeCheckedChangeListener((ViewGroup) group.getChildAt(i));
            }
        }
    }
    ...
    public RadioButton getRadioBtn(int index){
        return radioButtons.get(index);
    }

    public int getCheckedRadioBtnIndex(){
        for(int i=0,len=radioButtons.size();i<len;i++){
            if(radioButtons.get(i).getId()==mCheckedId){
                return i;
            }
        }
        return -1;
