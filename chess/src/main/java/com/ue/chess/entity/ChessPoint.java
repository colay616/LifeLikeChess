...
public class ChessPoint {
    ...
    private void initImgGenerator(int f, int c) {
        switch (f) {
            ...
            case ChessUtil.QUEEN:
                ...
                break;
            case ChessUtil.M_PAWN_F:
            case ChessUtil.M_PAWN:
            case ChessUtil.O_PAWN_F:
            case ChessUtil.O_PAWN:
    ...
    public void showValidMoves(ChessPoint[][] qzs) {
        mGenerator.showValidMoves(qzs, this);
    }
}