...
public abstract class EaseChatRow extends LinearLayout {
    ...
    private void setUpBaseView() {
        ...
        if(message.direct() == Direct.SEND){
            EaseUserUtils.setUserAvatar(context, PreferenceManager.getCurrentUserAvatar(), userAvatarView);
        }else{
            String tempStr=message.getStringAttribute(EaseConstant.USER_AVATAR,"noAvatar");
            EaseUserUtils.setUserAvatar(context, tempStr, userAvatarView);

            tempStr=message.getStringAttribute(EaseConstant.USER_NICK,message.getFrom());
            EaseUserUtils.setUserNick(tempStr, usernickView);
        }
