...
public class EaseConversationList extends ListView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        primaryColor = ta.getColor(R.styleable.EaseConversationList_cvsListPrimaryTextColor, R.color.black_000);
        secondaryColor = ta.getColor(R.styleable.EaseConversationList_cvsListSecondaryTextColor, R.color.gray_888888);
        timeColor = ta.getColor(R.styleable.EaseConversationList_cvsListTimeTextColor, R.color.gray_888888);
