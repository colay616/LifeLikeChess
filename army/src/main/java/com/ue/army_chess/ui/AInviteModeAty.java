...
public class AInviteModeAty extends BaseInviteModeAty {
    ...
    public void initAtyRes() {
        setAtyRes(R.layout.a_aty_invite_a, R.drawable.svg_blue_first, R.drawable.svg_yellow_last,GameConstants.GAME_ACA,"军棋-暗棋");
    ...
    private void initLayoutPopupWin() {
        mLayoutPopupWin = new LayoutPopupWin(AInviteModeAty.this);
        mLayoutPopupWin.setLayoutItemClicker(new LayoutPopupWin.OnLayoutItemClick() {
            ...
            public void onEditClick(LayoutItem layoutItem) {
                Intent intent = new Intent(AInviteModeAty.this, EditLayoutAty.class).putExtra("targetItem", layoutItem);
